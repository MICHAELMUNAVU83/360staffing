  ...
  return (
    <div class="w-[100%] py-16">
      <div class="w-[90%] flex flex-col justify-center items-center gap-4 mx-auto">
        ...
        <div class="md:text-5xl text-3xl arimo-bold leading-[48px] md:w-[60%] w-[90%] mx-auto flex flex-col justify-center items-center font-semibold">
          <p>Our Leadership Team</p>
        </div>
        <div class="grid mt-8 md:grid-cols-4 w-[100%] gap-6">
          {data.map((item) => (
            <div
